...
import videoCam from "/src/photos/video-camera (1).png"
const Navbar = () => {
            ...
            <div className="text-white flex items-center justify-around rounded-2xl w-full p-2 border border-[#ddd]">
                ...
                <div>
                    <div onClick={()=>{
                        ...
                        <span className={`h-0.5 transform tranistion-all duration-100 ease-in-out w-5 border ${isOpen?"rotate-45 translate-y-1 ":""} border-white`}></span>
                        <span className={`h-0.5 w-5 border ${isOpen?"hidden":"flex"} border-white`}></span>
                        <span className={`h-0.5 w-5 transform tranistion-all duration-100 ease-in-out border ${isOpen?"-rotate-45 -translate-y-0.5":""} border-white`}></span>
                    </div>
                ...
                <div className={`sidebar  md:hidden w-full p-5 h-1/2 backdrop-blur-2xl absolute bg-[rgba(255,255,255,0.4)] ${isOpen?"flex items-end justify-end flex-col":"hidden"} -z-30 top-15 `}>
                    <ul className="w-full flex flex-col items-center justify-around gap-5">
                        ...
                        <li className="w-full rounded-2xl hover:bg-gray-800 text-center p-2">Saved</li>
                        <li className="w-full rounded-2xl hover:bg-gray-800 text-center p-2">History</li>
                        <li className="w-full rounded-2xl hover:bg-gray-800 text-center p-2">Service</li>
                    </ul>
                </div>
            </div>
        </div>
